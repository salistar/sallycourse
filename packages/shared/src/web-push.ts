...
/**
 * Web Push natif (Prompt 156 ; déplacé de apps/web/src/lib/ vers
 * @sallycourse/shared au P200 pour que le WORKER puisse l'appeler — rappels de
 * streak quotidiens) — envoi de notifications navigateur SANS
